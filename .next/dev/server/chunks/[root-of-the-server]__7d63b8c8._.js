...
function getAdminApp() {
    if (!app) {
        ...
        app = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["initializeApp"])({
...
function getDb() {
    const a = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["getApps"])().length ? (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["getApps"])()[0] : getAdminApp();
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["getFirestore"])(a);
}
...
"[project]/lib/notify.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function notifyNewContact(data) {
    ...
    if (to && host && port && user && pass) {
        ...
        try {
            ...
            console.error("nodemailer verify failed", e?.message);
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notify$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/notify.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
async function POST(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notify$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyNewContact"])({
            name,
            email,
            message
        }).catch((err)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d63b8c8._.js.map